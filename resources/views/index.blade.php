...
<body>
  ...
  <div id="topbar" class="d-none d-lg-flex align-items-center fixed-top">
    <div class="container d-flex">
      ...
      <div class="social-links">
        <a href="https://t.me/pipsotrade" class="telegram"><i class="icofont-telegram"></i></a>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <!-- <h1 class="logo mr-auto"><a href="index.html">Pipsotrade<span>.</span></a></h1> -->
      <!-- Uncomment below if you prefer to use an image logo -->
      <a href="/" class="logo mr-auto"><img src="assets/img/logo-compact.png" alt=""></a>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              ...
              <p class="description">No talent or skill is needed for you to start making money. Let us do it for you.</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              ...
              <p class="description">Safe and secure investments with a guarantee of getting your profits</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
              ...
              <p class="description">Smartest way of making money at home. You only need a phone</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="400">
              ...
              <p class="description">Learn to do it on your own for free. Ask us how.</p>
            </div>
          </div>
    ...
    <section id="about" class="about section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Pipsotrade is a team of dedicated professional traders who specialize in trading forex and volatility indices.</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
            <h3>What pushed us to do it for the people</h3>
            <p class="font-italic">
              The love of changing the world pushed us to start helping people for free. Yes we also benefit in trading with larger funds but it's not only about us. It's about you.
            </p>
            <ul>
              <li>
                <i class="bx bx-store-alt"></i>
                <div>
                  <h5>Safe Investments</h5>
                  <p>Invest and earn. Leave us to do all the trading for you</p>
                </div>
              </li>
              <li>
                <i class="bx bx-images"></i>
                <div>
                  <h5>Free Signals and help</h5>
                  <p>Do it on your own if you have all the time to follow our free signals. No need to wait</p>
                </div>
              </li>
            </ul>
          </div>
