                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="ref" value="{{$ref ?? ''}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cellphone" type="text" class="form-control @error('cellphone') is-invalid @enderror" name="cellphone" value="{{ old('cellphone') }}" required autocomplete="name" autofocus>
